...
function handleNyxFrontDoor(userMessage, intentData = {}) {
  ...
  if (asksHelp) {
    return {
      ...
      domain: "general",
      message:
        "You can ask me about Sandblast TV, radio, streaming, News Canada content, advertising options, or AI consulting. Tell me the lane you care about, and I’ll map out a simple next move.",
    };
  }
