...
const VERSION = "composeMarionResponse v1.4.3 AUTOPSY-HARDENED-EMISSION-SAFE";
...
function composeMarionResponse(routed = {}, input = {}) {
  ...
  return {
    ...
    synthesis: {
      ...
      conversationState: { ...conversationState, selectedFunction, lastResponseFunction: selectedFunction },
      escalationProfile,
      memoryPatch: { lastResponseFunction: selectedFunction, arcState, engagementState, relationalStyle, emissionSafe: true }
    },
