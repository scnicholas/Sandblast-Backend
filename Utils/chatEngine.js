...
(function(){"use strict";const api=module.exports&&typeof module.exports==="object"?module.exports:null;if(!api||api.__e2eContinuityR9)return;const path=require("path"),root=path.join(__dirname,"..","Data","marion","runtime"),__e2eState=require(path.join(root,"marionContinuityState.js")),__e2eProgression=require(path.join(root,"marionConversationProgression.js")),__e2ePivot=require(path.join(root,"marionContextPivot.js"));
