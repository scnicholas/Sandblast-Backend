...
describe("FinanceNarrativeRenderer", () => {
  const mod = loadModule(["../../../Data/marion/runtime/finance/layer09_final_response/FinanceNarrativeRenderer.js", "../../../FinanceNarrativeRenderer.js", "../../../finance/FinanceNarrativeRenderer.js", "../../../finance/layer09_final_response/FinanceNarrativeRenderer.js", "../../../Data/finance/layer09_final_response/FinanceNarrativeRenderer.js", "../../../Data/Domains/finance/layer09_final_response/FinanceNarrativeRenderer.js", "../../../Domains/finance/layer09_final_response/FinanceNarrativeRenderer.js"]);
  const FinanceNarrativeRenderer = pickExport(mod, ["FinanceNarrativeRenderer", "NarrativeRenderer"]);

  const sectionMod = loadModule(["../../../Data/marion/runtime/finance/layer09_final_response/FinanceSectionRenderer.js", "../../../FinanceSectionRenderer.js", "../../../finance/FinanceSectionRenderer.js", "../../../finance/layer09_final_response/FinanceSectionRenderer.js", "../../../Data/finance/layer09_final_response/FinanceSectionRenderer.js", "../../../Data/Domains/finance/layer09_final_response/FinanceSectionRenderer.js", "../../../Domains/finance/layer09_final_response/FinanceSectionRenderer.js"]);
  const FinanceSectionRenderer = pickExport(sectionMod, ["FinanceSectionRenderer", "SectionRenderer"]);

  test("constructs without throwing", () => {
    expect(() => new FinanceNarrativeRenderer()).not.toThrow();
  });

  test("renders a coherent finalResponseText from rendered sections", () => {
    const sectionRenderer = new FinanceSectionRenderer();
    const sectionRender = callFirst(sectionRenderer, ["render", "renderSections", "run", "execute", "process"], sampleLayer08Envelope());

    const renderer = new FinanceNarrativeRenderer();
    const result = callFirst(renderer, ["render", "renderNarrative", "run", "execute", "process"], {
      ...sampleLayer08Envelope(),
      renderedSections: sectionRender.renderedSections,
      finalResponseBlocks: sectionRender.finalResponseBlocks
    });

    expect(result.finalResponseText).toBeTruthy();
    expect(result.finalResponseText.toLowerCase()).toContain("based on");
    expect(result.finalResponseText.toLowerCase()).toContain("supported findings");
    expect(result.finalResponseBlocks.length).toBeGreaterThan(0);
  });

  test("adds a caveat-oriented closing when caveats are present", () => {
    const sectionRenderer = new FinanceSectionRenderer();
    const sectionRender = callFirst(sectionRenderer, ["render", "renderSections", "run", "execute", "process"], sampleLayer08Envelope());
    ...
    expect(result.finalResponseText.toLowerCase()).toContain("caveat");
  });

  test("output is JSON-serializable", () => {
    const renderer = new FinanceNarrativeRenderer();
    const result = callFirst(renderer, ["render", "renderNarrative", "run", "execute", "process"], { renderedSections: [] });
