 ...
 *
 * Critical patch:
 * - Removed node:test import. Jest does not count node:test tests as Jest tests,
 *   which causes "0 tests" / suite-shell failures even when assertions pass.
...
const {
  ...
  shouldBlockRequest
} = runtimeModule('languagesphere', 'LanguageSphereFallbackPolicy.js');
...
describe('LanguageSphere fallback safety', () => {
