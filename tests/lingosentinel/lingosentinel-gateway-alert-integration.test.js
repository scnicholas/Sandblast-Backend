...
/**
 * LingoSentinel Gateway Alert Integration Test
 *
 * Purpose:
 * Confirms LingoSentinelGateway carries unknown-language alert metadata
...
function assertAlertCarry(packet) {
  ...
  expect(packet.unknownLanguageAlert.authority.lingoSentinelAdvisoryOnly).toBe(true);
...
describe("LingoSentinel Gateway Alert Integration", () => {
