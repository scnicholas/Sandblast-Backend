...
/**
 * LingoSentinel Alert Routing Policy Test
 *
 * Purpose:
...
} = require("../../Data/marion/runtime/LingoSentinel/LingoSentinelAlertRoutingPolicy");
...
describe("LingoSentinel Alert Routing Policy", () => {
  test("module exports policy functions", () => {
    ...
    expect(ALERT_ROUTING_POLICY_VERSION).toBe("nyx.lingosentinel.alertRoutingPolicy/0.1");
  });
  ...
  test("extracts alert surface from LingoSentinel gateway unknown input", () => {
    ...
    expect(surface.source).toBe("LingoSentinelAlertRoutingPolicy");
  });
