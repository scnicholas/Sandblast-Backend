...
/**
 * LingoSentinel Index Chat Route Contract Test
 *
 * Purpose:
 * Verifies that index.js carries the LingoSentinel rendering-path contract
 ...
 * - This test confirms the index layer contains the expected LingoSentinel
...
describe("LingoSentinel Index Chat Route Contract", () => {
  ...
  test("index.js contains LingoSentinel gateway integration surfaces", () => {
    const source = readIndexSource();
  ...
  test("index.js preserves Marion authority language around LingoSentinel carry", () => {
    const source = readIndexSource();
     ...
     * LingoSentinel advises; Marion authorizes; index renders.
     */
  ...
  test("index.js does not appear to expose internal LingoSentinel metadata as public reply text", () => {
    const source = readIndexSource();
  ...
  test("LingoSentinelGateway can build chat-route-safe payload for English input", () => {
  ...
  test("LingoSentinelGateway can build chat-route-safe payload for French input", () => {
  ...
  test("LingoSentinelGateway can build chat-route-safe payload for Spanish input", () => {
  ...
  test("LingoSentinelGateway can build chat-route-safe payload for unknown-language fallback", () => {
  ...
  test("LingoSentinel gateway package remains JSON-safe for index transport", () => {
    const cases = [
  ...
  test("index contract keeps LingoSentinel as advisory transport, not final authority", () => {
    const payload = buildMarionBridgePayload("Bonjour, comment ca va?");
