...
/**
 * LingoLink Glossary Preservation Test
 *
 * Purpose:
...
} = require("../../Data/marion/runtime/LingoLinkGlossaryGuard");

describe("LingoLink Glossary Preservation", () => {
  ...
  test("restores missing protected terms conservatively", () => {
    ...
    expect(result.guardedText).toContain("[LingoLink]");
    expect(result.restoredTerms).toContain("Marion");
    expect(result.restoredTerms).toContain("LingoLink");
