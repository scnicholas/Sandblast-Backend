...
/**
 * LingoLink Runtime Rendering Regression Test
 *
 * Purpose:
 * Protects the backend rendering path after the LingoLink Translation Advisor fix.
 *
 * This test confirms:
...
} = require("../../Data/marion/runtime/LingoLinkTranslationAdvisor");
...
describe("LingoLink Runtime Rendering Regression", () => {
  ...
  test("LingoLink Gateway returns render-safe package for English input", () => {
  ...
  test("LingoLink Gateway returns render-safe package for French input", () => {
  ...
  test("LingoLink Gateway returns render-safe package for Spanish input", () => {
  ...
  test("LingoLink Gateway returns render-safe package for unknown input", () => {
