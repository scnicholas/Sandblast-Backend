...
/* MARION_NUANCE_PHASE_B_CrossDomainCohesion_V1_START */
(function marionNuancePhaseBCrossDomainCohesionV1(){
  "use strict";
  const api=module.exports&&typeof module.exports==="object"?module.exports:null;
  if(!api||api.__marionNuancePhaseBCrossDomainCohesionV1)return;
  ...
  const original=api.analyze;if(typeof original==="function")api.analyze=function(input={}){const b=phaseB(input),s=summary(b),out=original.call(this,input);return {...obj(out),phaseBNuanceSummary:s,phaseBPrimaryStance:s.primaryStance,phaseBPrimaryPragmaticIntent:s.primaryPragmaticIntent,subtextMayCreateDomain:false,stanceMayCreateDomain:false,figurativeLanguageMayCreateDomain:false,culturalIdentityInferenceAllowed:false,literalIntentPreserved:true};};

  api.MARION_NUANCE_PHASE_B_CONTRACT=PHASE_B_CONTRACT;
  api.MARION_LAYER_HARD_STOP=HARD_STOP_LAYER;
  api.__marionNuancePhaseBCrossDomainCohesionV1=true;
})();
/* MARION_NUANCE_PHASE_B_CrossDomainCohesion_V1_END */
