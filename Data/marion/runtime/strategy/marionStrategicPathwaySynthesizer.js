...
/* MARION_NUANCE_PHASE_B_StrategicPathwayCohesion_V1_START */
(function marionNuancePhaseBStrategicPathwayCohesionV1(){
  "use strict";
  const api=module.exports&&typeof module.exports==="object"?module.exports:null;
  if(!api||api.__marionNuancePhaseBStrategicPathwayCohesionV1)return;
  ...
  const original=api.analyze;if(typeof original==="function")api.analyze=function(input={}){const b=phaseB(input),s=summary(b),out=original.call(this,input);return {...obj(out),phaseBPrimaryStance:s.primaryStance,phaseBPrimaryPragmaticIntent:s.primaryPragmaticIntent,decisiveStanceMayApprovePathway:false,subtextMaySelectPathway:false,figurativeLanguageMaySelectPathway:false,requiresApproval:true,safeToExecute:false,literalIntentPreserved:true};};

  api.MARION_NUANCE_PHASE_B_CONTRACT=PHASE_B_CONTRACT;
  api.MARION_LAYER_HARD_STOP=HARD_STOP_LAYER;
  api.__marionNuancePhaseBStrategicPathwayCohesionV1=true;
})();
/* MARION_NUANCE_PHASE_B_StrategicPathwayCohesion_V1_END */
