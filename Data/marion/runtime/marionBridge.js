...
function priority90BridgeRepairReply(prompt){
  ...
  if(source)return "Marion has the current prompt. The bridge will return one clean final answer and suppress stale fallback language.";
  return "";
}
