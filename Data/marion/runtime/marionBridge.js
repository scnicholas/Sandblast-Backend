...
(function(){
  "use strict";
  const V="nyx.publicSurfaceIdentityLock.runtime/marionBridge/1.0";
  ...
  try{
    ...
    wrapObj(module.exports,["processWithMarion","route","maybeResolve","ask","handle","handleVoiceTranscript","handleVoiceInput","default"]);
...
;(function(){
  "use strict";
  const PATCH_VERSION="marionBridge continuity + TV transport projection v1.0-r1";
  ...
  const WRAP_NAMES=["run", "default", "handle", "handleChat", "chat", "reply", "processWithMarion", "route", "maybeResolve", "ask", "handleMessage", "composeMarionResponse", "compose", "buildReply", "createMarionFinalEnvelope", "createMarionErrorEnvelope", "normalizeFinalEnvelope", "buildFinalEnvelope", "toFinalEnvelope", "finalize"];
