...
function normalizeLingoLinkGatewaySurfaceForBridge(value={}){
  ...
  return {
    ...
    advisoryText: firstText(translationMeta.advisoryText, translationMeta.translatedText),
