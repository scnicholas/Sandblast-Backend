...
function isProgressionShapingRefinementPrompt(text="",input={},routed={}){
  ...
  return /\bprogression shaping|progression refinement|progression test|5 turn progression|5 turn|continuity depth|depth governor\b/i.test(ctx) ||
