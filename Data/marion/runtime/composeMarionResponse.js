...
function applyConfidenceAwareResponseShaping(reply="",profile={},intent="",text="",input={}){
  ...
  if(p.needsClarifier&&p.clarifier&&!isNyxMarionBackendTechnicalContext(text))return p.clarifier;
  if(!out)return out;
