...
function neutralDefinitionBridge(term="",domains=[]){
  ...
  if(/\brisk\b/i.test(t))return "Risk generally means the chance that uncertainty, exposure, or a weak control will create harm, loss, failure, or an unwanted outcome.";
  if(/\bcompliance\b/i.test(t))return "Compliance generally means meeting required rules, standards, duties, or operating expectations in a specific context.";
