...
function priority90ContextRepairReply(prompt,intent){
  ...
  if(source)return "Marion will continue the active task with one clean, concrete answer instead of replaying a fallback.";
