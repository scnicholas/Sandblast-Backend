...
function buildFinalLoopRecoveryReply(intent,text,input={}){
  ...
  return "I stopped a repeated fallback and reset this turn to the latest user message only.";
}
