...
function domainConfidenceUserReply(input = {}, routed = {}) {
  ...
  if (detectIdentityIntent(extractText(routed, input))) return identityReply(extractText(routed, input), input);
  return "I need one more concrete detail to route this cleanly. Give me the specific target or outcome, and I’ll answer directly.";
}
