...
function priority9IJRouteMetadata(input,base){var text=priority9IJRoutePrompt(input);var src=[text,priority9IJCollect(input),priority9IJCollect(base)].join(" ");if(priority9IJIs9JActivationText(text)||priority9IJIs9JActivationText(src)){return {...priority9IJObj(base),intent:"contextual_directive",canonicalIntent:"contextual_directive",domain:"execution_context",routeKind:"priority9j_proactive_operational_guidance",priorityLane:"Priority 9J",priority9JProactiveOperationalGuidance:priority9JStateFrom(src,1),confidence:0.997,shouldClarify:false,noUserFacingDiagnostics:true};}if(priority9IJIs9IActivationText(text)||priority9IJIs9IActivationText(src)||priority9IJIsPressureText(text)){return {...priority9IJObj(base),intent:"contextual_directive",canonicalIntent:"contextual_directive",domain:"execution_context",routeKind:"priority9i_adaptive_situational_reasoning",priorityLane:"Priority 9I",priority9IAdaptiveSituationalReasoning:priority9IStateFrom(src,1),priority9JPrecheck:priority9IStateFrom(src,1).priority9JProactiveGuidancePrecheck,confidence:0.997,shouldClarify:false,noUserFacingDiagnostics:true};}return base;}
